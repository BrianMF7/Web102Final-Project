  ...
  return (
    <div className="create-post">
      <div className="create-post-container">
        ...
        <p>Share your pick for the greatest soccer player of all time!</p>

        <form onSubmit={handleSubmit} className="create-post-form">
          <div className="form-group">
            <label htmlFor="name">Soccer Player Name *</label>
            <input
              type="text"
              id="name"
              name="name"
              ...
              placeholder="e.g., Lionel Messi, Cristiano Ronaldo, Pelé..."
              required
            />
          </div>
          ...
          <div className="form-group">
            ...
            <input
              ...
              onChange={handleInputChange}
              placeholder="e.g., Why Messi is the undisputed GOAT"
              required
            />
          </div>
